...
$res = $conn->query($sql);
$rowEmprestimo = $res->fetch_object();
    ...
    <div class="form-group row">
        ...
        <div class="col-md-4">
            ...
            <select name="livro_id_livro" id="livro_id_livro" class="form-select">
                ...
                while ($livro = $resLivro->fetch_object()) {
                    if ($livro->id_livro == $rowEmprestimo->livro_id_livro) {
                        echo "<option selected value='$livro->id_livro'>$livro->titulo_livro</option>";
                    } else {
        ...
        <div class="col-md-3">
            ...
            <select name="usuario_id_usuario" id="usuario_id_usuario" class="form-select">
                ...
                while ($usuario = $resUsuario->fetch_object()) {
                    if ($usuario->id_usuario == $rowEmprestimo->usuario_id_usuario) {
                        echo "<option selected value='$usuario->id_usuario'>$usuario->nome_usuario</option>";
                    } else {
        ...
        <div class="col-md-3">
            ...
            <select name="funcionario_id_funcionario" id="funcionario_id_funcionario" class="form-select">
                ...
                while ($funcionario = $resFuncionario->fetch_object()) {
                    if ($funcionario->id_funcionario == $rowEmprestimo->funcionario_id_funcionario) {
                        echo "<option selected value='$funcionario->id_funcionario'>$funcionario->nome_funcionario</option>";
                    }
        ...
        <div class="form-group row mt-3">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="date" class="form-control" id="data_emprestimo" name="data_emprestimo" value="<?php echo $rowEmprestimo->data_emprestimo; ?>" />
            </div>

            <!-- Campo para inserir a Data de Devolução -->
            <div class="col-md-4">
                <label for="data_devolucao">Data de Devolução</label>
                <input type="date" class="form-control" id="data_devolucao" name="data_devolucao" value="<?php echo $rowEmprestimo->data_devolucao; ?>" />
            </div>
        </div>
